      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="relative flex flex-col min-h-full pt-24 pb-8 px-6">
              {/* Navigation Links */}
                  ...
                  {mainNavigation.map((item, index) => (
                    ...
                    >
                      <Link
                        ...
                        onClick={onClose}
                        className={cn(
                          'block py-4 font-mono text-base transition-colors border-b border-cream-400',
                          isActive(item.href)
                            ? 'text-igda font-bold'
              ...
              >
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 flex items-center justify-center border-2 border-ink-300 text-ink-600 hover:bg-igda hover:border-igda hover:text-white transition-all"
                  >
